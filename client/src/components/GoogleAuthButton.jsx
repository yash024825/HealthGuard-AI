...
export default function GoogleAuthButton({ redirectTo = "/dashboard" }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-2 border border-[var(--color-border)] bg-white hover:bg-gray-50 disabled:opacity-60 text-[var(--color-text)] font-medium py-2.5 rounded-lg transition-colors text-sm"
    >
